                    ...
                    <tr className="border-b border-border/40 hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="px-5 py-3">
                        <div className="flex items-center justify-end gap-2">
                          <Link href={`/report/${r.id}`} className="px-3 py-1.5 rounded-md border border-border text-xs font-medium text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors">
                            View Report
                          </Link>
                          {isAdmin && (
